...
exports.passport = (app) => {
    ...
    passport.use('admin', new LocalStrategy(
        ...
        function(username, password, done) {
            logger.warn('username of LocalStrategy admin: ', username);
            logger.warn('password of LocalStrategy: ', password);
    ...
    passport.use('user', new LocalStrategy(
        ...
        function(username, password, done) {
            logger.warn('username of LocalStrategy user: ', username);
            logger.warn('password of LocalStrategy: ', password);
            logger.warn('username of LocalStrategy: ', username);
            logger.warn('password of LocalStrategy: ', password);
